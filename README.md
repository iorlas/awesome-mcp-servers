...
- <img src="https://cdn.simpleicons.org/postgresql/5865F2" height="14"/> [a2db](https://github.com/agentic-eng/a2db) - Multi-database agent access (PostgreSQL, SQLite, MySQL, Oracle, SQL Server) with batch queries, pre-configured connections, and SQLGlot-enforced read-only safety
